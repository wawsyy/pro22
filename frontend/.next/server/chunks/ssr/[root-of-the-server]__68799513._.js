...
"[project]/frontend/app/error-filter.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ErrorFilter() {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const filteredError = (...args)=>{
            ...
            if (message.includes("cca-lite.coinbase.com") || message.includes("Analytics SDK") || message.includes("Failed to fetch") && (message.includes("coinbase") || firstArg?.message?.includes("coinbase") || firstArg?.stack?.includes("coinbase"))) {
                return;
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__68799513._.js.map